...
def get_args():
    ...
    parser.add_argument('--safety_filter',    action='store_true', default=None, help="Explicitly enable safety filter")
    parser.add_argument('--no_safety_filter', action='store_true', default=None, help="Explicitly disable safety filter")
    parser.add_argument('--map',              type=str, default=None, help="Map name to run: map1, map2, or warehouse")
